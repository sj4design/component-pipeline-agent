...
|---------|-------|---------|
| 1. Material Design 3 | 24–58 | MUI keyboard, focus, disabled, errors |
| 2. Spectrum / React Aria | 59–142 | Adobe hooks, press events, FocusScope |
| 3. Carbon (IBM) | 143–208 | Focus ring, disabled, error patterns |
| 4. Polaris (Shopify) | 209–246 | Keyboard, focus, errors, SR support |
| 5. Atlassian | 247–276 | Keyboard, focus, errors, SR |
| 6. Ant Design | 277–311 | Keyboard, ARIA gaps, disabled, errors |
| 7. Radix UI | 312–366 | Per-component keyboard tables, data attrs |
| 8. Headless UI | 367–426 | Per-component keyboard tables, focus |
| 9. Cross-System Consensus | 427–465 | Default rules (use as baseline) |
| 10. Actionable Rules | 466–537 | Generation rules for the agent |
